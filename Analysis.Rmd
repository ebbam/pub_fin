...
p5b <- temp_dfi %>% 
  ...
  labs(x = "Year", y = "Expenditure per capita (thousands)", title = "Composition of Broad National Expenditure Categories") +
...
p6 <- temp_dfi %>% 
  ...
  facet_wrap(~region, scales = "free") +
  labs(x = "Year", y = "Share of expenditure", title = "Share of Total 'Welfare' Expenditure by Category and Region") +
...
# Data Coverage: Broad Categories and Total Expenditure

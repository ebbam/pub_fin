...
dict = c(pinc_k_pc = "Personal Income (pc_k)",
         ...
         "fit_region::Northeast:fd_annual_avg_emplvl_2121" = "Region_{NE}xCoal Emp Brtk",
         "fit_region::South:fd_annual_avg_emplvl_2121" = "Region_{S}xCoal Emp Brtk",
         "fit_region::North Central:fd_annual_avg_emplvl_2121" = "Region_{NC}xCoal Emp Brtk",
         "fit_region::West:fd_annual_avg_emplvl_2121" = "Region_{W}xCoal Emp Brtk",
         "fit_low_econ_div::0:fd_annual_avg_emplvl_2121" = "EconDiv_{low}xCoal Emp Brtk",
         "fit_low_econ_div::1:fd_annual_avg_emplvl_2121" = "EconDiv_{high}xCoal Emp Brtk",
         "fit_l(fd_annual_avg_emplvl_211, 2)" = "O&G Emp Brtk (l2)",
         "fit_l(fd_annual_avg_emplvl_211, 1)" = "O&G Emp Brtk (l1)",
         "fit_region::Northeast:fd_annual_avg_emplvl_211" = "Region_{NE}xO&G Emp Brtk",
         "fit_region::South:fd_annual_avg_emplvl_211" = "Region_{S}xO&G Emp Brtk",
         "fit_region::North Central:fd_annual_avg_emplvl_211" = "Region_{NC}xO&G Emp Brtk",
         "fit_region::West:fd_annual_avg_emplvl_211" = "Region_{W}xO&G Emp Brtk",
         "fit_low_econ_div::0:fd_annual_avg_emplvl_211" = "EconDiv_{low}xO&G Emp Brtk",
         "fit_low_econ_div::1:fd_annual_avg_emplvl_211" = "EconDiv_{high}xO&G Emp Brtk",
          "fit_l(fd_annual_avg_emplvl_21, 2)" = "Extr. Emp Brtk (l2)",
         "fit_l(fd_annual_avg_emplvl_21, 1)" = "Extr. Emp Brtk (l1)",
         "fit_region::Northeast:fd_annual_avg_emplvl_21" = "Region_{NE}xExtr. Emp Brtk",
         "fit_region::South:fd_annual_avg_emplvl_21" = "Region_{S}xExtr. Emp Brtk",
         "fit_region::North Central:fd_annual_avg_emplvl_21" = "Region_{NC}xExtr. Emp Brtk",
         "fit_region::West:fd_annual_avg_emplvl_21" = "Region_{W}xExtr. Emp Brtk",
         "fit_low_econ_div::0:fd_annual_avg_emplvl_21" = "EconDiv_{low}xExtr. Emp Brtk",
         "fit_low_econ_div::1:fd_annual_avg_emplvl_21" = "EconDiv_{high}xExtr. Emp Brtk"
         )
      ...
      if(nrow(tmp) != 0){
        ...
        for(dep in deps){
          cat('##### ', toupper(dep), '{.tabset}   \n')
            tmp %>% filter(dep_var == dep) %>% pull(bartik_base_year) %>% print
